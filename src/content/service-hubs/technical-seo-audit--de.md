...
faq:
  ...
  - question: "Was ist der Unterschied zwischen einem SEO Audit und einem SEO Check?"
    answer: "Der SEO Check ist ein kostenloses Web-Tool und liefert eine Stichprobe der Citability-Dimension als Orientierung. Das SEO Audit ist ein bezahltes Deliverable mit allen sechs AISO-Score-Dimensionen, manueller Expertenprüfung und einem 60-minütigen Walkthrough mit Ihrem Entwicklungsteam. Den Check starten Sie unter [/aiso-check/](/aiso-check/) ohne Erstgespräch."
---
...
Im Unterschied zu einem reinen SEO-Tool oder einer Generalisten-Agentur arbeitet eine spezialisierte SEO Audit Agentur an der Schnittstelle aus klassischer Suche und KI-Suche. Tools wie Screaming Frog oder Sitebulb finden Crawl-Fehler, bewerten sie aber nicht im Geschäftskontext. Eine Audit-Agentur priorisiert nach Impact auf Ihre Sichtbarkeit, ordnet Befunde im Verhältnis zu Ihrem Tech-Stack ein und übersetzt sie in eine Reihenfolge, die Ihr Entwicklungsteam abarbeiten kann.
...
Ein Audit ist nur so präzise wie die Datenquellen darunter. StarkRank kombiniert für die sechs AISO-Score-Dimensionen ein bewusst reduziertes, datenbankfähiges Stack:

- **Screaming Frog** für vollständigen Crawl, Spider-Konfigurations-Exports und custom-extractions zur JSON-LD-Validierung pro Template
...
Was in diesem Stack absichtlich fehlt: SaaS-Tools, die einen 100-Punkte-Score ohne offene Methodik vergeben (`Site Health 87/100` ohne nachvollziehbare Berechnung). Der AISO Score ist deshalb pro URL nachprüfbar — Sie können den Score nachrechnen, statt einer Black Box vertrauen zu müssen.

## SEO Audit vs SEO Check: wo ist der Unterschied?

In der deutschsprachigen SEO-Branche werden "Audit" und "Check" oft austauschbar verwendet. Bei StarkRank sind es zwei getrennte Produkte mit klarer Funktion. Der **Check** ist ein kostenloses Lead-Magnet-Format auf einer öffentlichen URL: Sie geben Ihre Domain ein und bekommen eine Stichprobe der Citability-Dimension als orientierenden Score. Das **Audit** ist ein bezahltes Deliverable mit allen sechs AISO-Score-Dimensionen, manueller Expertenprüfung und einem 60-minütigen Walkthrough mit Ihrem Entwicklungsteam.

| Dimension | SEO Check (kostenlos) | SEO Audit (Festpreis) |
|-----------|------------------------|--------------------------|
| Lieferform | Web-Tool, sofortige Stichprobe | PDF-Report plus 60-Min-Walkthrough |
...
Diese Muster sind nicht zufällig. Sie spiegeln die spezifische Kombination aus deutscher Datenschutz-Regulierung (DSGVO), Bot-Protection-Defaults der großen CDN-Anbieter und fehlendem Bewusstsein für die KI-Crawler-Welle wider.
