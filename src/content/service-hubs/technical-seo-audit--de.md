...
faq:
  ...
  - question: "Was ist der Unterschied zwischen einem SEO Audit und einem SEO Check?"
    answer: "Der SEO Check ist ein kostenloses Web-Werkzeug und liefert eine Stichprobe der Citability-Dimension als Orientierung. Das SEO Audit ist ein bezahltes Liefer-Produkt mit allen sechs AISO-Score-Dimensionen, manueller Expertenprüfung und einer 60-minütigen Durchsprache mit Ihrem Entwicklungsteam. Den Check starten Sie unter [/aiso-check/](/aiso-check/) ohne Erstgespräch."
---
...
## AISO Score: die sechs Audit-Dimensionen mit Gewichtung

Klassische SEO-Audits liefern Checklisten, eine SEO Audit Agentur sollte ein gewichtetes Bewertungsraster liefern. Der AISO Score (AI Search Optimisation — KI-Suchoptimierung) verteilt 100 Punkte auf sechs Dimensionen, dokumentiert jede pro URL und macht Befunde damit zwischen Audit-Runs reproduzierbar vergleichbar. Diese sechs Dimensionen sind:
...
Ein Audit ist nur so präzise wie die Datenquellen darunter. StarkRank kombiniert für die sechs AISO-Score-Dimensionen einen bewusst reduzierten, datenbankfähigen Werkzeug-Stack:
...
Was in diesem Werkzeug-Stack absichtlich fehlt: SaaS-Werkzeuge, die einen 100-Punkte-Score ohne offene Methodik vergeben (`Site Health 87/100` ohne nachvollziehbare Berechnung). Der AISO Score ist deshalb pro URL nachprüfbar — Sie können den Score nachrechnen, statt einer Black Box vertrauen zu müssen.

## SEO Audit vs SEO Check: wo ist der Unterschied?

In der deutschsprachigen SEO-Branche werden "Audit" und "Check" oft austauschbar verwendet. Bei StarkRank sind es zwei getrennte Produkte mit klarer Funktion. Der **Check** ist ein kostenloses Lead-Magnet-Format auf einer öffentlichen URL: Sie geben Ihre Domain ein und bekommen eine Stichprobe der Citability-Dimension als orientierenden Score. Das **Audit** ist ein bezahltes Liefer-Produkt mit allen sechs AISO-Score-Dimensionen, manueller Expertenprüfung und einer 60-minütigen Durchsprache mit Ihrem Entwicklungsteam.
