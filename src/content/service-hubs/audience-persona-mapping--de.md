...
processSteps:
  - name: "Bestehende Daten auswerten (GA4, GSC, CRM)"
    description: "30-minütiger Kick-off, Audit vorhandener Quellen (GA4, Google Search Console, CRM, Meta Audience Insights, bestehende Persona-Dokumente), Review von 10 bis 20 Sales-Gespräch-Transkripten oder -Notizen, Sammlung typischer Einwände und Kauf-Auslöser."
    tools:
      - "Google Analytics 4"
      - "Google Search Console"
      - "CRM (HubSpot, Pipedrive, Salesforce)"
      - "Meta Audience Insights"
  - name: "SERP-Intent-Analyse pro Demand-Theme"
    description: "Analyse der Suchanfragen, über die Nutzer heute Ihre Site oder Wettbewerber erreichen; Identifikation der typischen Fragen an ChatGPT, Perplexity und Claude zum Thema; Clustering nach Intent-Typ (informational, navigational, commercial, transactional) als Grundlage für die Persona-×-Search-Intent-Matrix."
    tools:
      - "DataForSEO"
      - "NeuronWriter"
      - "AlsoAsked, AnswerThePublic"
  - name: "Buyer-Persona-Synthese (3 bis 5 Personas)"
  ...
  - name: "Customer-Journey-Mapping pro Persona"
    description: "Pro Persona konkrete Aktivierung: Ad-Targeting-Parameter (Meta-Interests, LinkedIn-Segmente, Lookalike-Seeds), Landingpage-Varianten-Empfehlungen, Content-Themen-Priorisierung, CRM-Segmentierungs-Kriterien, E-Mail-Sequenz-Hooks pro Funnel-Stufe."
  - name: "Validierung über Conversion-Daten"
    description: "Definition messbarer Hypothesen pro Persona (welche CAC, welche CVR, welche Sales-Cycle-Länge erwarten wir), 90-Tage-Check-in-Kalender zur Überprüfung der Persona-Modelle gegen tatsächliche Conversion-Daten, Revisions-Rhythmus."
faq:
  - question: "Was gehört alles zu einer Zielgruppenanalyse?"
    answer: "Eine vollständige Zielgruppenanalyse umfasst sechs Bausteine: Auswertung bestehender Daten (GA4, Google Search Console, CRM, Meta Audience Insights), Sales-Gesprächs-Inputs (10 bis 20 Transkripte oder Notizen), Search-Intent- und KI-Query-Analyse, Synthese in 3 bis 5 funktionale Buyer Personas, Customer-Journey-Mapping pro Persona mit konkreten Ad-, Landingpage- und CRM-Hooks, und einen Validierungs-Plan mit messbaren Hypothesen für die ersten 90 Tage. Eine Zielgruppenanalyse ohne Validierungs-Plan ist Recherche, kein operatives Werkzeug."
...
Nach der Zielgruppenanalyse haben Sie drei Wege, die Ergebnisse operativ zu nutzen. Erstens internes Operating: Ihre bestehenden Marketing- und Sales-Teams übernehmen mit den Persona-Artefakten als Betriebs-Handbuch — gut geeignet, wenn interne Kapazität vorhanden ist. Zweitens externe Agentur-Übergabe: Ihre bestehende Content-, Ads- oder Web-Agentur bekommt die Persona-Dokumente und integriert sie in Briefings und Kampagnen-Setups. Drittens StarkRank-Retainer: wir setzen die Personas in unserer laufenden Arbeit um — in [Content Marketing](/services/content-marketing-agentur/), [SEO-Texterstellung](/services/seo-texterstellung/), [Google Ads Management](/services/google-ads-management/) oder [Paid-Social-Strategie](/services/paid-social-strategy/), mit GA4-seitiger Validierung über unsere [Google Analytics Beratung](/services/google-analytics-consultancy/).
