...
features:
  - "Capsule Content Technique — H2-as-question + 40–60 word answer blocks for snippet eligibility"
  - "Sub-query fan-out anticipation per DataForSEO 2026 study (47% trigger rate, 93% with 2 sub-queries)"
  - "Information Gain hypotheses surfaced per article — three statements not present in the top-10 SERP"
  - "E-E-A-T compliance pass + Anti-AI writing discipline before delivery"
  - "Schema markup per content type (Article, FAQPage, HowTo, Service) and IndexNow trigger at publish"
  - "Performance tracking — Google Search Console + GA4 30-day report per article"
relatedServices:
  - "content-marketing"
  - "copywriting-audit"
  - "ai-search-optimization"
faq:
  - question: "Do you write individual articles or only on retainer?"
    answer: "Both. Individual articles work for specific needs (an important landing page, a pillar article, a relaunch page). For ongoing production of four or more articles per month, a retainer is usually more economical — including editorial calendar and topic research (Content Marketing service)."
  - question: "Do you use AI tools for writing?"
    answer: "For structural support functions (keyword research, semantic coverage check, readability analysis, brief structuring) yes. For final text production no — the final text is written by humans with subject-matter expertise. Full disclosure of where we use AI and where we don't is in the section 'How we use AI — and where we don't' above."
  - question: "How is SEO copywriting different from content writing?"
    answer: "Content writing is the broader discipline (any content for a website or campaign). SEO copywriting specifically optimizes for organic search rankings AND AI citation. The Capsule Content Technique covers both layers — Google Featured Snippet eligibility (40–60 word blocks, keyword in first 20 words) and AI Overview / ChatGPT extractability (self-contained chunks with clean entity naming)."
  - question: "What's a realistic ranking expectation?"
    answer: "Depends on competitive intensity. For long-tail terms in moderate-competition niches: top-10 within 8–12 weeks of publishing for well-briefed pages. For head terms in saturated SERPs (e.g. SaaS authority brands have entrenched positions): top-10 may not be realistic with copy alone — additional levers (technical SEO, link building, paid acceleration) become necessary. We calibrate expectations per topic in the discovery call."
---
...
We agree the fixed price before brief sign-off — you know upfront what the article costs, and price changes only happen if you change the scope. For ongoing production (four or more articles per month), a Content Marketing retainer is more economical; the retainer bands are published on the [pricing page](/preise/seo/) and on our [Content Marketing](/en/services/content-marketing/) service page.

For a quick assessment of your existing copy, the [Copywriting Audit](/en/services/copywriting-audit/) evaluates a single page across three surface dimensions and positions whether further audit work or direct rewriting is the next step.
...
If SEO copywriting could be a fit for your business, the next step is a [discovery call](/en/contact/). 30 minutes by phone — we look at the topic pipeline, the competitive landscape, the choice between individual articles and a retainer, and realistic ranking expectations per topic. If a different service is the better lever — for instance a [Copywriting Audit](/en/services/copywriting-audit/) or a [Content Marketing](/en/services/content-marketing/) retainer — we will say so. You get a substantive recommendation, not a sales pitch.
