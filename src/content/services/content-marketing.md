...
features:
  ...
  - "Content briefings with Information Gain hypotheses"
  - "Article production with anti-AI editorial review"
  - "E-E-A-T-compliant editorial and structured data markup"
...
faq:
  - question: "How is content marketing different from SEO copywriting?"
    answer: "Content marketing is the strategy — what to create, for whom, and why. SEO copywriting is the execution — writing individual pieces optimised for search. We develop the content strategy, then either produce the content ourselves through our SEO Copywriting service or provide briefs and editorial plans for your in-house team."
  - question: "How do you make content visible to AI search engines?"
    answer: "We apply our documented five-element AI optimisation methodology: capsule content technique (question-phrased H2s with self-contained 40–60-word answer blocks), Information Gain hypotheses (specific statements not already in the top 10 results), anti-AI writing discipline (a documented list of patterns AI systems demote), entity anchor coverage (consistent naming plus Schema.org markup so platforms can attribute you correctly), and query fan-out anticipation (covering the follow-up queries AI systems statistically generate from a single user prompt). Each piece is written so AI platforms can extract clear answers and cite your content as a source — not just rank it in a list."
  - question: "How long before content marketing shows results?"
    answer: "Individual pieces can rank within weeks for lower-competition queries. Topical authority — where you become the go-to source for a subject — typically takes 3–6 months of consistent publication. AI citation frequency follows a similar curve as your content library grows and gains third-party references."
  - question: "Do you write the content or just plan it?"
    answer: "Both. We develop the strategy (topics, formats, editorial calendar, distribution) and produce the content. For clients with in-house writers, we provide detailed content briefs with keyword targets, structure guidelines, and competitive analysis — then review and optimise the drafts."
  - question: "What types of content do you create?"
    answer: "Blog posts, long-form guides, whitepapers, case studies, FAQ pages, landing page copy, email sequences, and social content. The format depends on where your audience is in the buyer journey and which formats perform best for your industry. We recommend based on data, not assumptions."
---
...
**Important context:** these timelines assume moderate competitive intensity. In low-competition niches, top rankings can come noticeably earlier; in highly competitive themes — generic finance, insurance, or travel keywords — the timeframe can double, or top-3 rankings simply aren't achievable through content marketing alone. In that case additional levers are needed: authority link building, technical SEO, paid media — or substantially higher budgets over substantially longer periods. Competitive intensity is outside our control; we assess it per topic in the [free discovery call](/en/contact/) and calibrate expectations accordingly rather than make unrealistic promises.
...
- **Companies with real in-house experts whose knowledge hasn't been systematically documented.** The combination of [Expert Library](/expertenbibliothek/) and content marketing retainer is the biggest lever here.
...
Content marketing retainers follow our published [SEO pricing](/preise/seo/):
