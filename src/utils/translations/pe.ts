export const pe: Record<string, string> = {
  ...
  'spoke.getStarted': 'Agenda una primera reunión con StarkRank',
  'spoke.getStartedCheck': 'Solicita tu chequeo de búsqueda IA gratuito',
  'spoke.home': 'Inicio',
  ...
  'consent.manage': 'Configuración de cookies',
  'consent.status.granted': 'Su configuración actual: aceptado.',
  'consent.status.denied': 'Su configuración actual: rechazado.',
